...
public class MeshGenerator : MonoBehaviour
{
    ...
    public void GenerateMesh(int[,] map, float squareSize, Material mat, bool hasCollider)
    {
        ...
        meshObject.transform.position = new Vector3(0, 0, 4);
        meshObject.transform.rotation = Quaternion.Euler(new Vector3(-90, 0, 0));
        meshObject.transform.localScale = new Vector3(0.05f, 1, 0.05f);
    ...
    void AssignVertices(Node[] points)
    {
        for (int i = 0; i < points.Length; i++)
        {
            ...
            {
                points[i].vertexIndex = vertecis.Count;
                vertecis.Add(points[i].position);
            }
        }
    }
